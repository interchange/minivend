/* tlink.c:  runs as a cgi program and passes request to Vend server
   ...
   $Id: tlink.c,v 1.1 1996/03/06 08:28:58 mike Exp mike $
   ...
   $Log: tlink.c,v $
   Revision 1.1  1996/03/06 08:28:58  mike
   Initial revision
...
#define LINK_HOST "bill.iac.net"
#define LINK_PORT 2345
#define LINK_TIMEOUT 30
#define PERL     "/usr/bin/perl"
#define VEND     "/usr/local/lib/vend/minivend.pl"
